...
public class CubeHigh extends SequentialCommandGroup {
  /** Creates a new CubeHigh. */
  public CubeHigh(DriveSubsystem drive, ArmSubsystem armRotation, ArmExtensionSubsystem armExtension, PneumaticsSubsystem pneumatics, IntakeSubsystem intake) {
