...
public class HumanPlayerStationPosition extends ParallelCommandGroup {
  /** Creates a new HighArmPosition. */
  public HumanPlayerStationPosition(ArmExtensionSubsystem m_armExtensionSubsystem, PneumaticsSubsystem m_pneumaticsSubsystem, ArmSubsystem m_armSubsystem) {
